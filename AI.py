...
# ==========================================
    ...
    with col_lead:
        st.markdown(f"""
            <div class='lead-card'>
                <h2 style='margin-bottom:0;'>Tanishq Sharma</h2>
    ...
    with col2:
        st.markdown("<div class='member-card'><h3>Yogesh Kumar</h3><p>Data Analyst</p></div>", unsafe_allow_html=True)

    with col3:
        st.markdown("<div class='member-card'><h3>Sahejpreet Singh</h3><p>ML Engineer</p></div>", unsafe_allow_html=True)

    with col4:
        st.markdown("<div class='member-card'><h3>Yashasvi Gupta</h3><p>Risk Analyst</p></div>", unsafe_allow_html=True)
